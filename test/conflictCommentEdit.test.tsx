...
describe("Conflict comment edit flow", () => {
	...
	const setupSavedComment = async () => {
		...
		const conflictButton = addCommentButtons.find(
	...
	it("should show pencil icon on hover over saved comment", async () => {
		...
		const commentCard = screen
			.getByText("Test resolution comment")
	...
	it("should save edited comment text", async () => {
		...
		await waitFor(() => {
			expect(
				screen.getByText("Updated resolution comment"),
			).toBeInTheDocument();
			expect(
				screen.queryByDisplayValue("Updated resolution comment"),
			).not.toBeInTheDocument(); // Not in edit mode
		});
	});
	...
	it("should delete comment when Discard is clicked", async () => {
		...
		await waitFor(() => {
			expect(
				screen.queryByText("Test resolution comment"),
			).not.toBeInTheDocument();
		});
	});
	...
	it("should support Escape key to cancel edit", async () => {
		...
		await waitFor(() => {
			expect(screen.getByText("Test resolution comment")).toBeInTheDocument();
			expect(
				screen.queryByDisplayValue("This should not be saved"),
			).not.toBeInTheDocument();
		});
	});
	...
	it("should support Cmd+Enter to save edit", async () => {
		...
		await waitFor(() => {
			...
			expect(
				screen.queryByDisplayValue("Quick save edit"),
			).not.toBeInTheDocument();
		});
	});
