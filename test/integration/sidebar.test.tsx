  ...
  describe("multi-select workspaces", () => {
    ...
    it("should support multi-select interactions while keeping the main repository unselectable", async () => {
      const getSidebarElements = async () => {
        ...
        const mainRepoRow = sidebarRoot!.querySelector('[data-testid="home-repo-row"]');
      ...
      const {
        workspace1: cmdWorkspace1,
        workspace2: cmdWorkspace2,
      ...
      rerender(<Dashboard />);
      const {
        workspace1: shiftWorkspace1,
        workspace2: shiftWorkspace2,
      } = await getSidebarElements();
