...
pub fn dispatch(command: &str, args: Value) -> Result<Value, String> {
  match command {
    ...
    "get_pr_info_via_gh" => {
      ...
      let info =
        treq_lib::github::get_pr_info_via_gh_impl(&gh, &repo_path, &branch_name, &extended_path)?;
    ...
    "get_pr_checks_via_gh" => {
      ...
      let extended_path = treq_lib::binary_paths::get_extended_path();
      let status =
        treq_lib::github::get_pr_checks_via_gh_impl(&gh, &repo_path, &branch_name, &extended_path)?;
    ...
    "gh_list_issues" => {
      ...
      let limit = get_optional_u32(&args, "limit")?.unwrap_or(treq_lib::github::GH_LIST_PAGE_SIZE);
    ...
    "gh_view_issue" => {
      ...
      let extended_path = treq_lib::binary_paths::get_extended_path();
      let issue =
        treq_lib::github::gh_view_issue_impl(&gh, &repo_full_name, issue_number, &extended_path)?;
    ...
    "gh_close_issue" => {
      ...
      let gh = gh_bin()?;
      let extended_path = treq_lib::binary_paths::get_extended_path();
      treq_lib::github::gh_close_issue_impl(&gh, &repo_full_name, issue_number, &extended_path)?;
      Ok(Value::Null)
    }
    ...
    "gh_reopen_issue" => {
      ...
      let gh = gh_bin()?;
      let extended_path = treq_lib::binary_paths::get_extended_path();
      treq_lib::github::gh_reopen_issue_impl(&gh, &repo_full_name, issue_number, &extended_path)?;
      Ok(Value::Null)
    }
    ...
    "gh_view_pr" => {
      ...
      let gh = gh_bin()?;
      let extended_path = treq_lib::binary_paths::get_extended_path();
      let pr = treq_lib::github::gh_view_pr_impl(&gh, &repo_full_name, pr_number, &extended_path)?;
    ...
    "get_workspace_changed_files" => {
      ...
      let files =
        treq_lib::core::list_changed_files(&repo_path, workspace_id).map_err(|e| e.to_string())?;
    ...
    "get_workspace_file_hunks" => {
      ...
      let hunks =
        treq_lib::core::list_file_hunks(&repo_path, workspace_id, &file_path, &conflict_style)
          .map_err(|e| e.to_string())?;
    ...
    "pull_workspace_from_remote" => {
      ...
      let conflict_style = get_conflict_style()?;
      let result =
        treq_lib::core::pull_workspace_from_remote(&repo_path, workspace_id, &conflict_style)?;
      serde_json::to_value(result).map_err(|e| e.to_string())
    }
    ...
    "rename_workspace" => {
      ...
      let dry_run: bool = args
        ...
        .unwrap_or(false);
      let result =
        treq_lib::core::rename_workspace(&repo_path, workspace_id, &new_branch_name, dry_run)?;
      serde_json::to_value(result).map_err(|e| e.to_string())
    }
    ...
    "get_commit_description" => {
      ...
      let commit_change_id = get_str(&args, "commitChangeId")?;
      let description =
        treq_lib::core::get_commit_description(&repo_path, workspace_id, &commit_change_id)?;
    ...
    "describe_commit" => {
      ...
      treq_lib::core::describe_commit(&repo_path, workspace_id, &commit_change_id, &description)?;
      Ok(Value::Null)
    }
    ...
    "set_session_model" => {
      let repo_path = get_str(&args, "repoPath")?;
      let id: i64 = get_i64(&args, "id")?;
      let model: Option<String> = args.get("model").and_then(|v| v.as_str()).map(String::from);
    ...
    "add_prompt_history" => {
      ...
      let agent: Option<String> = args.get("agent").and_then(|v| v.as_str()).map(String::from);
    ...
    "get_workspace_starting_prompt" => {
      let repo_path = get_str(&args, "repoPath")?;
      let workspace_id: i64 = get_i64(&args, "workspaceId")?;
      let entry = treq_lib::local_db::get_workspace_starting_prompt(&repo_path, workspace_id)?;
    ...
    "search_workspace_files" => {
      ...
      let limit: usize = args
        ...
        .unwrap_or(50);
      let files =
        treq_lib::local_db::search_workspace_files(&repo_path, workspace_id, &query, limit)?;
    ...
    "rebase_home_repo_branch" => {
      ...
      let result =
        treq_lib::jj::jj_rebase_home_repo_branch(&repo_path, &current_branch, &target_branch)
          .map_err(|e| e.to_string())?;
      serde_json::to_value(result).map_err(|e| e.to_string())
    }
    ...
    "dry_run_home_repo_rebase" => {
      ...
      let target_branch = get_str(&args, "targetBranch")?;
      let result =
        treq_lib::jj::jj_dry_run_home_repo_rebase(&repo_path, &current_branch, &target_branch)
          .map_err(|e| e.to_string())?;
      serde_json::to_value(result).map_err(|e| e.to_string())
    }
    ...
    "jj_check_branch_exists" => {
      ...
      let branch_name = get_str(&args, "branchName")?;
      let result =
        treq_lib::jj::check_branch_exists(&repo_path, &branch_name).map_err(|e| e.to_string())?;
      serde_json::to_value(result).map_err(|e| e.to_string())
    }
    ...
    "jj_restore_file" => {
      ...
      let file_path = get_str(&args, "filePath")?;
      let result =
        treq_lib::jj::jj_restore_file(&workspace_path, &file_path).map_err(|e| e.to_string())?;
      Ok(Value::String(result))
    }
