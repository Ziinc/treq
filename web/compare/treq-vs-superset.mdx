...
Treq organizes agent work as linked, reviewable layers. That matches the landing-page claim that a large feature should ship as smaller PRs that stay in sync. Diff comments return to the agent. Auto-rebase keeps the stack current. Conflicts stay in the review loop instead of becoming a separate merge chore.
