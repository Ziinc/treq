...
The need for review comes from how AI fails. Generated code is often syntactically valid and may pass its tests while still misunderstanding a business rule, weakening security, or conflicting with an earlier design decision. This is the [AI slop](/learn/concepts/ai-engineering/ai-assisted-software-engineering) problem that review exists to catch. A deliberate approval step catches mistakes that automated checks cannot.
