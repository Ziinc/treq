...
Use clones or a stronger sandbox when jobs must not share Git refs or config. Use containers, virtual machines, or separate user accounts when they must not share credentials or host access.
