...
[Treq](/docs/concepts/workspaces) is a workspace manager for Git repositories. Its managed workspaces live under `.treq/workspaces/`. They are not Git worktrees. Treq colocates Jujutsu with Git so workspace stacks auto-rebase when targets move. You do not need Jujutsu knowledge to use Treq.
