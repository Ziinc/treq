...
Use cherry-pick for an isolated change such as a backport, or to [move a commit into the workspace it belongs in](/learn/how-to/moving-files-between-workspaces). Use rebase when a branch should continue from a different point in history.
