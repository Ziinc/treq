...
Create a branch at an orphaned tip you still need:
...
It also cannot recover history rewritten only on a remote by someone else. Another clone's reflog never reaches you. Keep protected branches free of unexpected force pushes, and coordinate when a shared tip must move.
