...
Treq models the same idea as **stacked workspaces**. One workspace targets another workspace's bookmark instead of the default branch. When the lower workspace changes, Treq rebases dependents onto the new target, which [Workspaces](/docs/concepts/workspaces) covers in detail.
