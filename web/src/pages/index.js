...
function HomepageHeader() {
    return (<header className={styles.heroBanner} aria-label="Hero">
      <div className={styles.heroGlow}></div>
      <div className={styles.heroContainer}>
        <div className={styles.heroVisual}>
          <img className={styles.heroScreenshot} src={codeScreenshot} alt="Treq code overview screenshot"/>
        </div>
        ...
        <div className={styles.heroMain}>
          ...
          <div className={styles.buttons}>
            <Link className={clsx('button', styles.primaryButton)} href="https://github.com/Ziinc/treq/releases" target="_blank" rel="noopener noreferrer">
            ...
            <Link className={clsx('button', styles.secondaryButton)} to="/docs/getting-started/installation">
              Read the docs
            </Link>
          </div>
...
function ProblemSection() {
    return (<section className={styles.problemSection} aria-label="The problem">
...
function FeaturesSection() {
    return (<section className={styles.featuresSection} aria-label="Features">
      <div className={styles.featuresContainer}>
        ...
        <div className={styles.featureRow}>
          ...
          <div className={styles.featureScreenshot}>
            <img className={styles.featureImage} src={reviewScreenshot} alt="Treq code review screenshot showing comments sent to Claude"/>
          </div>
        </div>
...
function ClosingCTA() {
    return (<section className={styles.closingCTA} aria-label="Download">
      <div className={styles.closingCTAContainer}>
        ...
        <div className={styles.closingCTAButtons}>
          <Link className={styles.closingCTAButton} href="https://github.com/Ziinc/treq/releases" target="_blank" rel="noopener noreferrer">
...
export default function Home() {
    ...
    return (<Layout title={siteConfig.title} description="The Open Source Graphite Alternative">
      <HomepageHeader />
      <ProblemSection />
      <FeaturesSection />
      <ClosingCTA />
