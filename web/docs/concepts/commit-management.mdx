...
Give the agent one prompt describing how to resolve the conflicts. The agent starts in that resolve root. It can edit conflict markers in each change-id directory, or run:
