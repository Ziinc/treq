...
:::info[Install Jujitsu for a better debugging experience]

Install [Jujitsu (`jj`)](https://docs.jj-vcs.dev/latest/install-and-setup/) and add it to your `PATH`. Treq uses Jujitsu under the hood, and having `jj` available lets AI agents query repository state directly — useful when debugging workspace or branch behavior.
