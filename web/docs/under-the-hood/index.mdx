...
Treq opens an existing Git repository and initializes Jujutsu in colocated mode. Git handles remotes and hosted compatibility. Jujutsu supplies the revision model Treq uses for workspaces, stacks, and automatic rebases. Treq adds application state under `.treq`.
