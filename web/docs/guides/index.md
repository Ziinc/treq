...
Use Treq to inspect diffs like a GitHub PR, leave inline comments, and send those comments back to an agent for revision. Feedback stays tied to the specific code so agents can act on it in the background. With [GitHub Integration](/docs/concepts/github-integration) connected, you can also create and open real pull requests, read CI, and load GitHub review threads on the Review tab.
