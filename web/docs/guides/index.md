...
Treq is an AI coding environment for developers who use coding agents. It gives each task an isolated workspace, keeps those workspaces rebased as the underlying code changes, and lets you review agent output before it reaches your main branch.
...
Start with [Installation and Quickstart](getting-started/installation) to select a repository and create your first workspace.
