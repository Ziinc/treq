        ...
        <div className={styles.agentsIcons}>
          ...
          <div className={styles.agentIcon} title="Cursor">
            <span className={styles.cursorIcon} aria-hidden="true">
              <img
                className={clsx(styles.cursorIconImage, styles.cursorIconLight)}
                src="/assets/CUBE_2D_LIGHT.svg"
                alt=""
              />
              <img
                className={clsx(styles.cursorIconImage, styles.cursorIconDark)}
                src="/assets/CUBE_2D_DARK.svg"
                alt=""
              />
            </span>
            <span>Cursor</span>
