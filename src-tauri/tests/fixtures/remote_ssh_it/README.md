# `remote_ssh_server_it` fixture keypair
...
time. See `src-tauri/tests/remote_ssh_server_it.rs` for what it is used to
test.

If this key is ever rotated, regenerate both files with:
