...
/**
 * Copy text to the system clipboard. Prefers the async Clipboard API, then
 * falls back to a hidden textarea + execCommand for WebViews where
 * navigator.clipboard.writeText is missing or rejects.
 */
